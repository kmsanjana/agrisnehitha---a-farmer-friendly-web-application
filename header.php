	...
	<body class="homepage">
		...
		<div id="header" style="background-color:#e6d5cf;color:#a06450;" >
			<div class="container">
				...
				<!-- Logo -->
				<div id="logo">
					<h1><a href="index.php"><img src="images/logo.png" width="303" height="91" alt="Logo"/></a>                  
                    </h1>
				</div>
			</div>
            <!-- Nav -->
            ...
            ?>                   
                        ...
                        <li
                        <?php
						if(basename($_SERVER['PHP_SELF']) == "cropPrediction.php")
						{
                          echo ' class="active"';
						}
						?>><a href="cropPrediction.php"  style="color:#a06450;font-weight: bold;">Crop Prediction</a></li>
						<li
                        <?php
